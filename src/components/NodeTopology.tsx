...
export function NodeTopology() {
  return (
    <div className="bg-card-dark rounded-xl border border-border-dark p-6 shadow-sm overflow-hidden">
      ...
      <div className="aspect-square relative flex items-center justify-center bg-[radial-gradient(circle,#258cf4_1px,transparent_1px)] bg-[size:20px_20px] rounded-lg">
